...
namespace corsika {
  namespace media {
     ...
     *
     * @code
     * static constexpr Medium medium() { return media::Medium::HydrogenGas; }
     *
     ...
     *
     * inline static const MediumData data_ { "hydrogen_gas", "hydrogen gas
     * (H%2#)", 1.008, 3, 7, 0.99212, 8.3748e-05, 8.3755e-05, StateOfMatter::DiatomicGas,
