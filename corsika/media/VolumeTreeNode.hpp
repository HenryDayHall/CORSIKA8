...
#include <corsika/media/interfaces/IEmpty.hpp>
#include <memory>
#include <vector>
...
namespace corsika {
  namespace media {
    ...
    template <typename TModelProperties = media::IEmpty>
    ...
    public:
      ...
      /**
       * Traverses the VolumeTree pre- or post-order and calls the functor  \p func for
       * each node. \p func takes a reference to VolumeTreeNode as argument. The return
       * value \p func is ignored.
       */
