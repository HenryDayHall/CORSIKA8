...
namespace corsika {
  ...
  class HistoryWriter
      : public SecondariesProcess<HistoryWriter<TTracking, TOutput>>,
        public BaseOutput {
  ...
  public:
     ...
     */
    HistoryWriter(media::ShowerAxis const& axis,
...
#include <corsika/detail/modules/writers/HistoryWriter.inl>
