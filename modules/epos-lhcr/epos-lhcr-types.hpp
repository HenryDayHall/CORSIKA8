...
namespace EPOS_LHCR {
  ...
  inline unsigned int constexpr mxnody = 200;
   ...
   struct CPTL {
    int nptl;
    float pptl[EPOS_LHCR::mxptl][5];
    int iorptl[EPOS_LHCR::mxptl];
    int idptl[EPOS_LHCR::mxptl];
    int istptl[EPOS_LHCR::mxptl];
    float tivptl[EPOS_LHCR::mxptl][2];
    int ifrptl[EPOS_LHCR::mxptl][2];
    int jorptl[EPOS_LHCR::mxptl];
