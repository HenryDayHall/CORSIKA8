...
namespace sibyll23d {
    ...
    extern void (* const decpar_sib_)(const int&, const double*, int&, int*, double*) = &::decpar_sib_;
    extern void (* const sib_sigma_hnuc_)(const int&, const int&, const double&, double&, double&, double&) = &::sib_sigma_hnuc_;
    extern void (* const sib_sigma_hp_)(const int&, const double&, double&, double&, double&, double*, double&,
                                        double&) = &::sib_sigma_hp_;
